...
Dacnis is an innovative,  easily customizable, multi-purpose theme, focused on empowering users to build astonishing WordPress websites. Dacnis is mainly designed for small businesses, startups, or personal portfolio websites and works perfectly with Kubio Page Builder which enriches the WordPress block editor with a variety of new blocks and advanced styling options to give you full design freedom.

== Frequently Asked Questions ==

= How can I customize Dacnis? =

    To customize the Dacnis theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Dacnis WordPress theme, Copyright (C) 2021 ExtendThemes
Dacnis WordPress theme is licensed under the GPL3.
...
- Images
  ...
  These assets are distributed under the CC0 License:
        ...
        resources/images/hero-media-right.jpg
        License: CC0 1.0 Universal (CC0 1.0)
        Source: https://kaboompics.com/photo/21658/blue-anthurium-flower
...
- Google Fonts:
  ...
  Copyright © Florian Karsten | floriankarsten.github.io/space-grotesk
  ...
  Licensed under SIL Open Font License, 1.1 (https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)
  Copyright © Astigmatic

  Atkinson Hyperlegible (https://fonts.google.com/specimen/Syncopate)
  Licensed under SIL Open Font License, 1.1 (https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)
  Copyright © Braille Institute, Applied Design Works, Elliott Scott, Megan Eiswerth, Linus Boman, Theodore Petrosky
