			...
			<div>
				...
				<div class="kubio-onboarding__wrapper kubio-step-1">
					...
					<div class="kubio-onboarding__wrapper__content">
						<label>
							<input type="radio" id="kubio-install-new-homepage" name="kubio-onboarding-action" value="kubio-install-new-homepage" checked ai="true"></input>
							<div class="radio-card">
								<div class="radio-card__radio-checked">
									<?php echo file_get_contents( dacnis_theme()->getThemeResource( 'images/theme-base/check.svg' ) ); ?>
									<div class="radio-card__radio-checked__background"></div>
								</div>
								<div class="radio-card__image-container">
									<img src="<?php echo dacnis_theme()->getThemeResource( 'images/theme-base/web-layout.png' ); ?>" alt="web-layout" draggable="false">
								</div>
								<span>
						...
						<label>
							<input type="radio" id="kubio-keep-current-layout" name="kubio-onboarding-action" value="kubio-keep-current-layout"></input>
							<div class="radio-card">
								<div class="radio-card__radio-checked">
									<?php echo file_get_contents( dacnis_theme()->getThemeResource( 'images/theme-base/check.svg' ) ); ?>
									<div class="radio-card__radio-checked__background"></div>
								...
								<div class="radio-card__image-container">
									<img src="<?php echo dacnis_theme()->getThemeResource( 'images/theme-base/blog-layout.png' ); ?>" alt="blog-layout" draggable="false" >
								</div>
								<span>
				...
				<div class="kubio-onboarding__wrapper kubio-step-2">
					...
					<div class="kubio-onboarding__wrapper__content">
						...
						<ul>
							<li>
								<?php echo file_get_contents( dacnis_theme()->getThemeResource( 'images/theme-base/round-check.svg' ) ); ?>
